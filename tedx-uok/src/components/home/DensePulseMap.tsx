    ...
    <div className="w-full h-full flex justify-center items-center overflow-hidden">
      <style>
        {`
          ...
          @keyframes pinPulse {
              0% { transform: translate(-40px, -98px) scale(1); }
              50% { transform: translate(-40px, -105px) scale(1.1); }
              100% { transform: translate(-40px, -98px) scale(1); }
          }
        `}
      </style>
      ...
      <div className="relative w-full h-full bg-transparent overflow-hidden">
        ...
        >
          ...
          <image
            ...
            style={{
              filter: "brightness(0) saturate(100%) invert(15%) sepia(95%) saturate(6932%) hue-rotate(348deg) brightness(92%) contrast(114%)",
